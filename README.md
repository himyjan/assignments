...
```bash
npm install --save styled-components tailwindcss postcss autoprefixer @tanstack/react-table @tanstack/react-query @tanstack/react-query-devtools @tanstack/react-virtual@beta zustand react-redux @reduxjs/toolkit;npm install -D prettier prettier-plugin-tailwindcss --force;npx tailwindcss init
```
